#!/usr/bin/env python3
"""
Schema Validator for Incident Intelligence Agent Runtime.
...
class SchemaValidator:
    ...
    def _load_schemas(self):
        ...
        schema_files = {
            "incident_assessment_input": "incident_assessment_input.schema.json",
            "incident_analysis_output": "incident_analysis_output.json",
    ...
    def validate(self, payload: dict, schema_name: str) -> list:
        ...
        try:
            ...
            # Fallback to custom validation logic mimicking workflow_validator.py
