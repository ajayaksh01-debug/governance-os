...
VALID_TRANSITIONS = {
    ...
    "GATE_5_PASSED": {"SKILL_FM_RUNNING"},
    # Skill FM — ethana-feature-mapping (CA-local)
    "SKILL_FM_RUNNING": {"SKILL_FM_COMPLETE", "HALTED_ESCALATION"},
    "SKILL_FM_COMPLETE": {
        "GATE_FM_PASSED",
        "HALTED_GATE_FM_SCHEMA",
        "HALTED_GATE_FM_EMPTY_TABLE",
        "HALTED_FIREWALL_BREACH",
        "HALTED_GATE_FM_LOW_TFS",
    },
    "GATE_FM_PASSED": {"SKILL_6_RUNNING"},
    ...
    "HALTED_GATE_FM_SCHEMA": set(),
    "HALTED_GATE_FM_EMPTY_TABLE": set(),
    "HALTED_GATE_FM_LOW_TFS": set(),
...
FORBIDDEN_TRANSITIONS = [
    ...
    ("SKILL_FM_RUNNING", "SKILL_6_RUNNING"),
