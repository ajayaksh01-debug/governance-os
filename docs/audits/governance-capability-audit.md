# Governance OS — Governance Capability Audit (Consolidated)
...
## 2. Current Capability Map (Summary)
...
## 3. Missing Capability Map (Summary)
...
1.  **Client Onboarding Agent:** Orchestrates the Client Onboarding workflow to generate initial a (Refer to Section 6 below for detailed gaps).

---

## 6. Detailed Framework Decomposition & Gaps Analysis

This section contains the detailed, clause-by-clause analysis of all 16 capability domains (CAP-01 through CAP-16) mapped against the active/missing implementation states in the repository.
